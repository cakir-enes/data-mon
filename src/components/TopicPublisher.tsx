...
import { useFocusedTopic } from "../api/TopicHooks";
...
export const TopicPublisher = () => {
    let [focusedTopic, _] = useFocusedTopic()
    let [isPublishing, setIsPublishing] = useIsPublishing()
    useEffect(() => {console.log("RENDERING")}, [isPublishing])
    return (
        <div>
            {/* <Button text="sdf" onClick={() => setIsPublishing(!isPublishing)} /> */}
            <Dialog><p>sdfsdfsdfsdfds</p></Dialog>
